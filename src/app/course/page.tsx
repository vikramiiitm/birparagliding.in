...
import TCp1 from "../../../public/TCp1.png";
import TCp2 from "../../../public/TCp2.png";
import TCp3 from "../../../public/TCp3.png";
    ...
    <>
      ...
      <div className="py-10">
        <section>
          <div className="max-w-7xl h-full md:h-96 mx-auto flex flex-col-reverse md:flex-row py-10 relative px-5 z-10">
            <div className="flex flex-col gap-3 pt-20 md:pt-0">
              ...
              <p className="text-2xl font-bold">Duration :- 10 Days</p>
              <a
                href="http://"
                target="_blank"
                className="flex items-center gap-4 text-lg font-bold text-white bg-[#6ebf62] justify-center md:max-w-fit py-3 px-6 rounded-lg  mt-6"
        ...
        <section className="px-5">
          <h2 className="text-4xl font-bold text-center">Course Details</h2>
          <div className="flex flex-col-reverse md:flex-row gap-4 mt-4 max-w-7xl mx-auto items-center">
            ...
            <Image
              ...
              width={1000}
              height={1000}
              className="object-cover md:w-[10vw]"
              alt="TCP1"
            />
          </div>
          <div className="flex flex-col-reverse md:flex-row gap-4 mt-4 max-w-7xl mx-auto items-center">
          ...
          <p className=" px-5 flex items-center justify-center font-bold text-center mt-6">
