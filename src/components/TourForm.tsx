...
//               onValueChange={(value) => {
//                 setFlypackage(value);
//                 setAmount(flypackage === "Classic" ? 1500 : 1500); // Adjust amounts as needed
//               }}
//             >
//               <SelectTrigger>
...
//               </SelectTrigger>
//               <SelectContent>
//                 <SelectItem value="Standard">Classic</SelectItem>
//               </SelectContent>
//             </Select>
//           </div>
//           {/* <div className="space-y-1">
...
//   const [flyDate, setFlyDate] = useState<string>("");
//   const [totalAmount, setTotalAmount] = useState<number>(1500);
//   const [flypackage, setFlypackage] = useState<string>("Standard"); // Added package state
//   const [couponCode, setCouponCode] = useState<string>("No Coupon");
//   const [discount, setDiscount] = useState<number>(0);
//   const [loading, setLoading] = useState<boolean>(false);
